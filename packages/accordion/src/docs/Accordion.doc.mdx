...
<Canvas>
  <Story id="ui-bootstrap-accordion--primary"/>
  <Story id="ui-bootstrap-accordion--secondary" />
  <Story id="ui-bootstrap-accordion--success" />
  <Story id="ui-bootstrap-accordion--danger" />
  <Story id="ui-bootstrap-accordion--warning" />
  <Story id="ui-bootstrap-accordion--info" />
  <Story id="ui-bootstrap-accordion--light" />
  <Story id="ui-bootstrap-accordion--dark" />
</Canvas>
