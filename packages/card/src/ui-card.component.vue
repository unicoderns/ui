<template>
  <div :class="classes" :style="style">
    ...
    <div :class="bodyClasses">
      ...
      <slot></slot>
      <!-- <a href="#" :class="theme.cssClass.link">Card link</a>
      <a href="#" :class="theme.cssClass.link">Another link</a> -->
    </div>
    <img
      v-if="imgBottom"
      :src="imgSrc"
...
import { computed, defineProps, useAttrs, toRefs } from 'vue'
...
const { variant, background, centerText } = toRefs(props)
...
const classes = computed((): string[] => {
  const variantClass = background.value
    ? theme.value.cssClass.variants[variant.value]
    : theme.value.cssClass.borderVariants[variant.value]
...
const bodyClasses = computed((): string[] => {
  const variantClass = background.value
    ? ''
    : theme.value.cssClass.textBorderVariants[variant.value]
