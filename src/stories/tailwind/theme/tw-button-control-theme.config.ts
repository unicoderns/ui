...
export const twButtonControlThemeConfigDefaults: ButtonControlThemeConfigModel = {
  cssClass: {
    main: 'inline-block text-base font-normal leading-normal text-center no-underline align-middle cursor-pointer select-none bg-transparent border border-solid border-transparent rounded-xl p-2 pr-3 pl-3 focus-within:ring-4 ring-gray-200 outline-none',
    ...
    sizes: {
      ...
      [SizeVariants.Medium]: '',
      [SizeVariants.Small]: 'p-1 pr-2 pl-2 rounded-lg text-sm',
    },
  },
}
