...
# Accesibility
Change the next properties to change the default accesibility text

| Name | Property | Default |
| ---- | ---- | ----------- |
| role | aria:role | `button` |

Check the page [what is aria](/docs/docs-aria--page#what-is-aria-config) to see how to config accesibility globally for buttons.
